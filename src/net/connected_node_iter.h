...
struct connected_node_iter_t {
    node_t *root;
    hash_t *node_neighborhood_hash;
    set_t *occurred_node_set;
    list_t *remaining_node_list;
};

connected_node_iter_t *connected_node_iter_new(node_t *root, hash_t *node_neighborhood_hash);
...
array_t *connected_node_array(node_t *root, hash_t *node_neighborhood_hash);
