...
void stats_counter_per_thread_add1(stats_counter_t *self, thread_id_t id);
void stats_counter_per_thread_sub1(stats_counter_t *self, thread_id_t id);

size_t stats_counter_total(stats_counter_t *self);
